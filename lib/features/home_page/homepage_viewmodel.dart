...
import 'package:mymovieapp/data/implementations/hive_repository_impl.dart';
...
class HomepageViewmodel {
  ...
  HiveRepository hiveRepository = HiveRepositoryImpl();
  ...
  Future getAllMovies() async {
    ...
    hiveRepository.movieListFromApi(movieList.value);
  }
